...
var getSessionSecretKey = function getSessionSecretKey() {
  if (process.env.NODE_ENV === 'production') {
    assert$1(process.env.SESSION_SECRET_KEY, 'You must provide the SESSION_SECRET_KEY environment variable in production. This used to sign and verify tokens. It should be 32 chars long.');
      ...
      while (1) {
        switch (_context7.prev = _context7.next) {
          ...
          case 31:
            ...
            hasQuarterExpiryTimePassed = persistedSession.expiresAt && differenceInMinutes(persistedSession.expiresAt, new Date()) < 0.75 * config.sessionExpiryMinutes;
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            expiresAt = addYears(new Date(), 30);
          ...
          case 32:
            ...
            _expiresAt = addMinutes(new Date(), config.sessionExpiryMinutes);
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 12:
            ...
            _expiresAt2 = addMinutes(new Date(), config.sessionExpiryMinutes);
...
export { AuthenticationError, authenticateUser, getSessionContext, hashPassword, passportAuth, verifyPassword };
//# sourceMappingURL=next-passport.esm.js.map
